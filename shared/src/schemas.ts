...
export const createLeadSchema = z.object({
  ...
  purchaseType: z.nativeEnum(PurchaseType).nullable().optional(),
  exchangeFlag: z.boolean().default(false),
  modelId: z.number().int().positive().nullable().optional(),
  variantId: z.number().int().positive().nullable().optional(),
  colourId: z.number().int().positive().nullable().optional(),
  assignedTo: z.number().int().positive().nullable().optional(),
  executiveName: z.string().max(100).nullable().optional(),
