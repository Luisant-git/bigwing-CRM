...
export default function LeadListPage() {
  ...
  const columns: Column<any>[] = [
    ...
    },
    {
      ...
      sortable: true,
      render: (l: any) => <span className="text-gray-500 whitespace-nowrap">{!Boolean(l.dmsEnquiryNo || l.linkedDmsEnquiryNo) || (l.channel?.name || l.channel) === "TELE" ? formatDateTime(l.createdAt) : "—"}</span>,
