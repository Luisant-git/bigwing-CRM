...
export default function ImportPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      {/* Developer Logs: Import History */}
      {isSeniorDeveloper && (
        <div className="mt-12 rounded-xl bg-white p-6 shadow-sm ring-1 ring-black/5">
          <h2 className="mb-4 flex items-center gap-2 text-lg font-bold text-[#1F3864]">
            <FileSpreadsheet size={20} /> Developer Logs: Import History
          </h2>
